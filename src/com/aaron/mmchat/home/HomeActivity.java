...
import com.aaron.mmchat.login.LoginActivity;
...
//        listener = (DrawerListener) menuFragment; 
    ...
    private void switchFragmentTo(int itemId)
    {
        ...
        if (mFragmentName != null && (fragment = fragmentManager.findFragmentByTag(mFragmentName)) != null)
        {
        ...
        {
            fragmentTransaction.add(R.id.main_content, Fragment.instantiate(this, fragmentClassName), mFragmentName);
        }
        else
        {
